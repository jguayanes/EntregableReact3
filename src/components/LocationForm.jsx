const LocationForm = ({ handleSubmit }) => {
  return (
    <form
      className="flex justify-center sm:grid grid-flow-col sm:justify-center max-w-[1000px] mx-auto"
      onSubmit={handleSubmit}
    >
      <input
        id="newLocation"
        className="text-white outline-none bg-black border-2 border-[#8eff8b] w-[240px] h-[60px] sm:w-[390px] "
        min={1}
        max={126}
